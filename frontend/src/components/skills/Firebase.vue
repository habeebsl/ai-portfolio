...
<template>
    <svg :class="className" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1823" height="2500" viewBox="0 0 256 351" preserveAspectRatio="xMidYMid">
        <defs>
